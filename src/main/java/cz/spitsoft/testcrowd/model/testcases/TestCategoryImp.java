...
public class TestCategoryImp<T> extends BaseEntity implements TestCategory<T> {
    @Column(name = "NAME")
    ...
    public TestCategoryImp(String name, String description, Boolean valid, Date createdOn, Date modifiedOn, User<T> modifiedBy) {
        super();
        this.name = name;
